...
const I18N = {
  ko: {
    ...
    confirmSaveQuiz: "퀴즈 진행 상태를 저장하고 나갈까요?\n(확인: 저장하고 메인으로 / 취소: 저장 없이 메인으로)",
  ...
  en: {
    ...
    confirmSaveQuiz: "Save your quiz progress before leaving?\n(OK: save and go home / Cancel: leave without saving)",
  ...
  ja: {
    ...
    confirmSaveQuiz: "クイズの進行状況を保存して戻りますか？\n(OK: 保存してホームへ / キャンセル: 保存せずホームへ)",
